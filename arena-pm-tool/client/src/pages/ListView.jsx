        ...
        <div className={`flex items-center gap-2 ${isSubtask ? 'pl-6' : ''}`}>
          ...
          <div className="flex-1 min-w-0">
            <button
              ...
              className={`text-sm font-medium text-foreground text-left hover:underline transition-colors duration-150 leading-tight truncate max-w-full block ${isCompleted ? 'line-through text-muted-foreground' : ''}`}
            >
              {task.title}
              {!isSubtask && hasSubtasks && (
