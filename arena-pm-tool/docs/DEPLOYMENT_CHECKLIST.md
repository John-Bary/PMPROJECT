...
2. Repository name: `todoria` (or your preferred name)
...
```bash
cd /home/user/PMPROJECT/todoria

# Add remote (replace YOUR_USERNAME with your GitHub username)
git remote add origin https://github.com/YOUR_USERNAME/todoria.git
...
**Files**: `/todoria/.gitignore`, `/todoria/client/.gitignore`, `/todoria/server/.gitignore`
...
```bash
cd /home/user/PMPROJECT/todoria/server
...
# Note the production URL (e.g., https://todoria-api.vercel.app)
```
...
```bash
cd /home/user/PMPROJECT/todoria/client
...
# Note the production URL (e.g., https://todoria.vercel.app)
```
...
| Variable | New Value |
|----------|-----------|
| `ALLOWED_ORIGINS` | `https://todoria.vercel.app,https://todoria-git-main-yourname.vercel.app` |
