...
function TaskCard({
  ...
  const handleAssigneeSelect = async (userId) => {
    try {
    ...
    <>
            ...
            <div className={`${compact ? 'mt-2' : 'mt-3'} ml-7 flex items-center gap-2 flex-wrap`}>
              ...
              <div className="relative" ref={assigneeDropdownRef} data-dropdown>
                <button
                  ...
                  title={task.assigneeName || 'Assign someone'}
                >
                  {task.assigneeName ? (
                    <div
                      className={`
                ...
                {showAssigneeDropdown && (
                  <AssigneeDropdown
                    users={users}
                    selectedIds={task.assigneeId ? [task.assigneeId] : []}
                    onToggle={(userId) => {
                      handleAssigneeSelect(userId === task.assigneeId ? null : userId);
                    }}
      ...
      {showPriorityDropdown && createPortal(
        <div
          ...
          className="fixed w-28 bg-white border border-gray-200 rounded-lg shadow-lg z-[100] animate-fade-in"
