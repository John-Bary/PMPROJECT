...
router.post('/', requireActiveSubscription, validate(createCategorySchema), createCategory);          // POST /api/categories
...
router.put('/:id', requireActiveSubscription, validate(updateCategorySchema), updateCategory);        // PUT /api/categories/:id
